...
public class JogosPegueNiveisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogos_pegue_niveis);

        btnFacil = findViewById(R.id.btn_pegue_nivel_facil);
        btnMedio = findViewById(R.id.btn_pegue_nivel_medio);
        btnDificil = findViewById(R.id.btn_pegue_nivel_dificil);
    ...
    private void abrirJogo(String dificuldade) {
        Intent intent = new Intent(JogosPegueNiveisActivity.this, JogosPegueGameplayActivity.class);
