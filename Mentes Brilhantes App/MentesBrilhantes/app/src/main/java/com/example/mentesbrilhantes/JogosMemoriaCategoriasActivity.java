...
public class JogosMemoriaCategoriasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogos_memoria_categorias);
    ...
    private void configurarBotoes() {
        configurarBotaoComAnimacao(btnAnimais, new Runnable() {
            @Override
            public void run() {
                abrirSelecaoNiveis("ANIMAIS");
            }
        });

        configurarBotaoComAnimacao(btnLugares, new Runnable() {
            @Override
            public void run() {
                abrirSelecaoNiveis("LUGARES");
            }
        });

        configurarBotaoComAnimacao(btnComidas, new Runnable() {
            @Override
            public void run() {
                abrirSelecaoNiveis("COMIDAS");
            }
        });
    ...
    private void abrirSelecaoNiveis(String categoria) {
        Intent intent = new Intent(JogosMemoriaCategoriasActivity.this, JogosMemoriaNiveisActivity.class);
