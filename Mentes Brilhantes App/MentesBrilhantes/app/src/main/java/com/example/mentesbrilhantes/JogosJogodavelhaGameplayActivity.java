...
public class JogosJogodavelhaGameplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atualizarBotoesPorVez();
    }

    // Atualiza cor dos botões baseado em quem é a vez
    private void atualizarBotoesPorVez() {
        if (playerXTurn) {
            // Vez do jogador X (usuário) - Azul
            btnExit.setImageResource(R.drawable.btn_jogos_sair_azul);
            btnReset.setImageResource(R.drawable.btn_jogar_novamente_azul);
        } else {
            // Vez do jogador O (oponente/bot) - Vermelho
            btnExit.setImageResource(R.drawable.btn_jogos_sair_vermelho);
            btnReset.setImageResource(R.drawable.btn_jogar_novamente_vermelho);
        }
    }
