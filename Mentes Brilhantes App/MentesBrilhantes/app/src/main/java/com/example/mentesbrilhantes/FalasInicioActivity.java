...
public class FalasInicioActivity extends AppCompatActivity {
    ...
    private String sexoUsuario; // NOVO
    ...
    private void mostrarPagina(int pagina) {
        ...
        switch (pagina) {
            case 1:
                // Página 1 - os botões principais não mudam por sexo
                btnSocial.setImageResource(R.drawable.btn_falas_social);
                btnLazer.setImageResource(R.drawable.btn_falas_lazer);
                btnComidas.setImageResource(R.drawable.btn_falas_comidas);
                btnBanheiro.setImageResource(R.drawable.btn_falas_necessidades);
                btnAvancar.setVisibility(View.VISIBLE);
                btnVoltar.setVisibility(View.GONE);
                break;

            case 2:
                // Página 2 - os botões principais não mudam por sexo
                btnSocial.setImageResource(R.drawable.btn_falas_emocoes);
                btnLazer.setImageResource(R.drawable.btn_falas_animais);
                btnComidas.setImageResource(R.drawable.btn_falas_lugares);
