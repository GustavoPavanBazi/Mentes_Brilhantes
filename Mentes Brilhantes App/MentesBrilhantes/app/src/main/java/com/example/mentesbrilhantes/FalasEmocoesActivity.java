...
public class FalasEmocoesActivity extends AppCompatActivity {
    ...
    private void reproduzirAudioEmocoes(int botao, int pagina) {
        ...
        if (pagina == 1) {
            switch (botao) {
                case 1:
                    audioResource = usarVozFeminina ? R.raw.emocoes_assustada_fem : R.raw.emocoes_assustado_mas;
                    break;
                case 2:
                    audioResource = usarVozFeminina ? R.raw.emocoes_brava_fem : R.raw.emocoes_bravo_mas;
                    break;
                case 3:
                    audioResource = usarVozFeminina ? R.raw.emocoes_cansada_fem : R.raw.emocoes_cansado_mas;
                    break;
                case 4:
            ...
            switch (botao) {
                case 1:
                    ...
                    break;
                case 2:
                    audioResource = usarVozFeminina ? R.raw.emocoes_nervosa_fem : R.raw.emocoes_nervoso_mas;
                    break;
                case 3:
                    audioResource = usarVozFeminina ? R.raw.emocoes_timida_fem : R.raw.emocoes_timido_mas;
                    break;
                case 4:
