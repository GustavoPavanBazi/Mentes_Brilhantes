...
public class VideoPlayerActivity extends AppCompatActivity {
    ...
    private void iniciarMonitoramentoRede() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N &&
                connectivityManager != null && networkCallback != null && !isMonitoringNetwork) {
            try {
    ...
    // MÉTODO CORRIGIDO - seguindo o exemplo funcional
    private void carregarVideo(String videoId) {
        // URL do YouTube Embed com youtube-nocookie.com para melhor performance
    ...
    private class SelectiveWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("youtube.com/embed/" + currentVideoId) ||
                    url.contains("youtube-nocookie.com/embed/" + currentVideoId) ||
