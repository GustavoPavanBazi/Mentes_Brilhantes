...
public class LoginManager {
    ...
    // Confirme o IP/porta corretos para o servidor PHP
    ...
    public static void login(Context context, String email, String password, final LoginCallback callback) {
        ...
        StringRequest postRequest = new StringRequest(
                ...
                response -> {
                    try {
                        ...
                        // A API retorna {"data":[{name,email}], "status":"success"} ou {"status":"error"}
                        if ("success".equalsIgnoreCase(obj.optString("status"))) {
                            ...
                            // Abre MainActivity automaticamente
        ...
        // Timeout de 30s, sem retries automáticos
