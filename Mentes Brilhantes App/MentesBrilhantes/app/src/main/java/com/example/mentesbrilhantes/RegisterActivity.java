                ...
                response -> {
                    try {
                        ...
                        if ("success".equalsIgnoreCase(status)) {
                            ...
                            String responsavel = user.optString("responsavel", "Não informado");
                            String celularResponsavel = user.optString("celular_responsavel", "Não informado");
                            String birthdate = user.optString("birthdate", "Não informado");

                            // Cria sessão de login persistente - ATUALIZADO COM 6 PARÂMETROS
                            SessionManager sessionManager = new SessionManager(context);
                            sessionManager.createLoginSession(userName, userEmail, userGender, responsavel, celularResponsavel, birthdate);
