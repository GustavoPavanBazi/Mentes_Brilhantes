...
public class JogosQuebracabecaGameplayActivity extends AppCompatActivity {
    ...
    private int[] puzzleImages = {
            R.drawable.puzzle_image_1,
            R.drawable.puzzle_image_2,
            R.drawable.puzzle_image_3,
            R.drawable.puzzle_image_4,
            R.drawable.puzzle_image_5,
            R.drawable.puzzle_image_6,
            R.drawable.puzzle_image_7,
            R.drawable.puzzle_image_8,
            R.drawable.puzzle_image_9,
            R.drawable.puzzle_image_10
    };
