...
public class JogosInicioActivity extends AppCompatActivity {
    ...
    private void configurarListeners() {
        configurarBotaoProtegido(btnQuebraCabeca, new Runnable() {
            ...
            public void run() {
                if (paginaAtual == 1) {
                    ...
                    // Página 2: Abre o jogo de contar números
                    startActivity(new Intent(JogosInicioActivity.this, JogosContarGameplayActivity.class));
                }
            }
        });
        ...
        configurarBotaoProtegido(btnJogoDaVelha, new Runnable() {
            ...
            public void run() {
                if (paginaAtual == 1) {
                    ...
                    // Página 2: Abre o jogo Pegue o Eggman (níveis)
                    startActivity(new Intent(JogosInicioActivity.this, JogosPegueNiveisActivity.class));
                }
            }
        });
        ...
        configurarBotaoProtegido(btnComidas, new Runnable() {
            ...
            public void run() {
                if (paginaAtual == 1) {
                    ...
                    startActivity(new Intent(JogosInicioActivity.this, JogosMemoriaCategoriasActivity.class));
                } else {
                    // Página 2: Abre o jogo da Cobrinha (níveis)
                    startActivity(new Intent(JogosInicioActivity.this, JogosCobrinhaNiveisActivity.class));
                }
            }
        });
        ...
        configurarBotaoProtegido(btnBanheiro, new Runnable() {
            ...
            public void run() {
                if (paginaAtual == 1) {
                    // Abre o jogo de conectar
                    startActivity(new Intent(JogosInicioActivity.this, JogosConectarCategoriasActivity.class));
                } else {
    ...
    private void mostrarPagina(int pagina) {
        switch (pagina) {
            case 1:
                ...
                btnComidas.setImageResource(R.drawable.btn_jogos_jogo_da_memoria);
                btnBanheiro.setImageResource(R.drawable.btn_jogos_conectar);
                btnAvancar.setVisibility(View.VISIBLE);
                btnVoltar.setVisibility(View.GONE);
                break;

            case 2:
                btnQuebraCabeca.setImageResource(R.drawable.btn_jogos_numeros);
                btnJogoDaVelha.setImageResource(R.drawable.jogos_pegue_eggman);
                btnComidas.setImageResource(R.drawable.cobrinha);
                btnBanheiro.setImageResource(R.drawable.btn_falas_comunicacao);
