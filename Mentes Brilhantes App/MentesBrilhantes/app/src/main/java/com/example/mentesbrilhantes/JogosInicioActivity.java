    ...
    private void mostrarPagina(int pagina) {
        switch (pagina) {
            case 1:
                ...
                btnComidas.setImageResource(R.drawable.btn_jogos_jogo_da_memoria);  // MUDANÇA AQUI
            ...
            case 2:
                btnQuebraCabeca.setImageResource(R.drawable.btn_falas_emocoes);
                btnJogoDaVelha.setImageResource(R.drawable.btn_falas_animais);
