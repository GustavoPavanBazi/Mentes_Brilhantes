...
public class FalasComidasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_falas_comidas);
                                    ...
                                    .withEndAction(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                                                @Override
                                                public void run() {
                                                    Log.d("FalasComidasActivity", "Liberando botões após 1 segundo fixo");
                                                    isAnyButtonProcessing = false;
                                                }
                                            }, 1000);
                                            isThisButtonActive = false;
    ...
    private void configurarListeners() {
        configurarBotaoAudioComDelay(btnAudio1, new Runnable() {
            @Override
            public void run() {
                reproduzirAudioComidas(1, paginaAtual);
            }
        });
        ...
        configurarBotaoAudioComDelay(btnAudio2, new Runnable() {
            @Override
            public void run() {
                reproduzirAudioComidas(2, paginaAtual);
            }
        });
        ...
        configurarBotaoAudioComDelay(btnAudio3, new Runnable() {
            @Override
            public void run() {
                reproduzirAudioComidas(3, paginaAtual);
            }
        });
        ...
        configurarBotaoAudioComDelay(btnAudio4, new Runnable() {
            @Override
            public void run() {
                reproduzirAudioComidas(4, paginaAtual);
            }
        });
    ...
    private void mostrarPagina(int pagina) {
        ...
        switch (pagina) {
            case 1:
                if (isFeminino) {
                    btnAudio1.setImageResource(R.drawable.btn_falas_fem_comidas_arrozfeijao);
                    btnAudio2.setImageResource(R.drawable.btn_falas_fem_comidas_doces);
                    btnAudio3.setImageResource(R.drawable.btn_falas_fem_comidas_frutas);
                    btnAudio4.setImageResource(R.drawable.btn_falas_fem_comidas_lanches);
                } else {
                    btnAudio1.setImageResource(R.drawable.btn_falas_mas_comidas_arrozfeijao);
                    btnAudio2.setImageResource(R.drawable.btn_falas_mas_comidas_doces);
                    btnAudio3.setImageResource(R.drawable.btn_falas_mas_comidas_frutas);
                    btnAudio4.setImageResource(R.drawable.btn_falas_mas_comidas_lanches);
                }
            ...
            case 2:
                if (isFeminino) {
                    btnAudio1.setImageResource(R.drawable.btn_falas_fem_comidas_pao);
                    btnAudio2.setImageResource(R.drawable.btn_falas_fem_comidas_salgados);
                    btnAudio3.setImageResource(R.drawable.btn_falas_fem_comidas_suco);
                    btnAudio4.setImageResource(R.drawable.btn_falas_fem_comidas_verduraslegumes);
                } else {
                    btnAudio1.setImageResource(R.drawable.btn_falas_mas_comidas_pao);
                    btnAudio2.setImageResource(R.drawable.btn_falas_mas_comidas_salgados);
                    btnAudio3.setImageResource(R.drawable.btn_falas_mas_comidas_suco);
                    btnAudio4.setImageResource(R.drawable.btn_falas_mas_comidas_verduraslegumes);
                }
    ...
    private void reproduzirAudioComidas(int botao, int pagina) {
        int audioResource = 0;
        ...
        if (pagina == 1) {
            switch (botao) {
                case 1:
                    audioResource = usarVozFeminina ? R.raw.comidas_arrozfeijao_fem : R.raw.comidas_arrozfeijao_mas;
                    break;
                case 2:
                    audioResource = usarVozFeminina ? R.raw.comidas_doces_fem : R.raw.comidas_doces_mas;
                    break;
                case 3:
                    audioResource = usarVozFeminina ? R.raw.comidas_frutas_fem : R.raw.comidas_frutas_mas;
                    break;
                case 4:
                    audioResource = usarVozFeminina ? R.raw.comidas_lanches_fem : R.raw.comidas_lanches_mas;
                    break;
            }
        } else {
            switch (botao) {
                case 1:
                    audioResource = usarVozFeminina ? R.raw.comidas_pao_fem : R.raw.comidas_pao_mas;
                    break;
                case 2:
                    audioResource = usarVozFeminina ? R.raw.comidas_salgados_fem : R.raw.comidas_salgados_mas;
                    break;
                case 3:
                    audioResource = usarVozFeminina ? R.raw.comidas_suco_fem : R.raw.comidas_suco_mas;
                    break;
                case 4:
                    audioResource = usarVozFeminina ? R.raw.comidas_legumesverduras_fem : R.raw.comidas_legumesverduras_mas;
                    break;
            }
        }
    ...
    private void reproduzirAudioImediato(int audioResource) {
        try {
            if (mediaPlayerAtual != null) {
                ...
                mediaPlayerAtual.release();
                mediaPlayerAtual = null;
                Log.d("FalasComidasActivity", "Áudio anterior parado");
            }

            mediaPlayerAtual = MediaPlayer.create(this, audioResource);
            if (mediaPlayerAtual != null) {
                mediaPlayerAtual.start();
                Log.d("FalasComidasActivity", "Novo áudio iniciado imediatamente");
                ...
                mediaPlayerAtual.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Log.d("FalasComidasActivity", "Áudio terminou e foi liberado");
                    }
                });
            }
        } catch (Exception e) {
            Log.e("FalasComidasActivity", "Erro ao reproduzir áudio: " + e.getMessage());
        }
    }
